> **Video Demonstration:** If the video in the `demo/` folder cannot be accessed, you may use this instead: [Google Drive Link](https://drive.google.com/file/d/1LLB1ptUedRFY2d53SRe03BE24PvG856q/view?usp=sharing)
...
2. Locate `LapusJoseIshmael3B.exe` in the repository root.
3. Double-click `LapusJoseIshmael3B.exe` to launch the application.
